...
const createCard = (i, obj) => {
  ...
  //   -----------------------
  const indecatorParnt = createElement("div");
  addClass(indecatorParnt, "indecators");
  addClass(indecatorParnt, "flex");
  appendElement(containerDiv, indecatorParnt);
  const dropdownDiv = createElement("div");
  addClass(dropdownDiv, "dropdown");
  appendElement(indecatorParnt, dropdownDiv);
  const dropbtn = createElement("p");
  addClass(dropbtn, "dropbtn");
  dropbtn.textContent = "indecator";
  ...
  addClass(indecatorValue, `indecatorValue`);

  indecatorValue.textContent = "..........";
  appendElement(indecatorParnt, indecatorValue);
